...
D3D12Viewer::D3D12Viewer(HWND hwnd, unsigned width, unsigned height)
	: m_hwnd(hwnd)
	, m_width(width)
	, m_height(height)
...
void D3D12Viewer::OnKeyDown(unsigned char keyCode)
{

}

void D3D12Viewer::OnKeyUp(unsigned char keyCode)
{
...
void D3D12Viewer::WaitForPreviousFrame()
{
